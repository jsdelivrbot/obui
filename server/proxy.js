...
var customProxyMiddleware = function(pathPrefix, endpoint) {
        ...
        console.log('custom path prefix: ' + pathPrefix);
        var zoneId = "";
        if(endpoint == "https://time-series-store-predix.run.aws-jp01-pr.ice.predix.io"){
                zoneId = "bb76beb4-9177-4239-a693-a6105e078c24";
        }
        ...
        return expressProxy(endpoint, {
                ...
                intercept: cleanResponseHeaders,
                decorateRequest: buildDecorator(zoneId)
        });
